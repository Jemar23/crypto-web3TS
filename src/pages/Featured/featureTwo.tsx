...
function FeatureTwo({ data }: {data: any}) {
    return(
        <div className="bg-slate-600 mx-auto overflow-auto h-screen">
            ...
            <p>Largest Sale: <span className="text-slate-100">Invisible Friend #1 sold for $1.2 million USD</span></p>
            </div>
            </div>
            <div> <LargestSale /> </div>
            <OpenSeaButton />
...
function LargestSale() {
    return(
        ...
        src="https://i.seadn.io/gae/CNFV7859j-yasLwsnpQN17bmOwUOQFM7qz-G5WG84SKcerIfth4nSO6-jAEz1q9Y52B90DY-NvZ6l5bVv-utMjCOtP09GhU0L3nT?auto=format&w=1000"
        alt="NFT Image"
        width={600}
        height={600} 
        />
...
export async function getStaticProps() {
    ...
    const res = await fetch('https://api.opensea.io/api/v1/collection/invisiblefriends', options)
