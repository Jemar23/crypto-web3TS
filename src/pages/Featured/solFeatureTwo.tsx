...
function SolFeatureTwo({ data }: {data: any}) {
    return(
        <div className="bg-black mx-auto overflow-auto h-screen">
            ...
            <p>Largest Sale: <span className="text-slate-100">Degen Ape #7225 sold for $1.1 Million USD</span></p>
            </div>
            </div>
            <div> <LargestSale /> </div>
            <OpenSeaButton />
...
function LargestSale() {
    return(
        ...
        src="https://i.seadn.io/gae/sd-CMl6n_jjjRm8pDWKW6e4mHQU-cTX_61tnmvOKW8mGLgRcrTPIKMTnPYExDTfV7DfoN9KR5Ay_r2gq11C93NtOczwRQBXnsuITWQ?auto=format&w=1000"
        alt="NFT Image"
        width={600}
        height={600} 
        />
...
export async function getStaticProps() {
    ...
    const res = await fetch('https://api.opensea.io/api/v1/collection/degenerate-ape-academy', options)
